...
enum llm_tensor {
    ...
    LLM_TENSOR_ENGRAM_EMBED_SCALE,
    LLM_TENSOR_ENGRAM_WKV,
    LLM_TENSOR_ENGRAM_Q,
    LLM_TENSOR_ENGRAM_K,
    LLM_TENSOR_ENGRAM_TOKEN_MAP,
    LLM_TENSOR_ENGRAM_PRIMES,
    LLM_TENSOR_ENGRAM_OFFSETS,
    LLM_TENSOR_ENGRAM_MULTIPLIERS,
